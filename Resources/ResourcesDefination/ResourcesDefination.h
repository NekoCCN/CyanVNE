...
namespace cyanvne
{
	namespace resources
	{
		...
		struct ResourceDefinition : public core::binaryserializer::BinarySerialiable
		{
			...
			ResourceDefinition(uint64_t id_val, const std::string& alias_val, uint64_t size_val, uint64_t offset_val, ResourceType type_val) :
				id(id_val), alias(alias_val), size(size_val), offset(offset_val), type(type_val)
			{  }
			...
			std::ptrdiff_t deserialize(cyanvne::core::stream::InStreamInterface& in) override
			{
				...
				bytes_read = core::binaryserializer::deserialize_object(in, id);
				if (bytes_read == -1)
				{
					return -1;
				}
			...
			std::ptrdiff_t serialize(cyanvne::core::stream::OutStreamInterface& out) const override
			{
				...
				bytes_written = core::binaryserializer::serialize_object(out, id);
				if (bytes_written == -1)
				{
					return -1;
				}
		...
		struct ResourcesFileIdentificationHeader : public core::binaryserializer::BinarySerialiable
		{
			...
			std::ptrdiff_t deserialize(core::stream::InStreamInterface& in) override
			{
				...
				bytes_read = core::binaryserializer::deserialize_object(in, version);
				if (bytes_read == -1)
				{
					return -1;
				}
			...
			std::ptrdiff_t serialize(cyanvne::core::stream::OutStreamInterface& out) const override
			{
				...
				bytes_written = core::binaryserializer::serialize_object(out, version);
				if (bytes_written == -1)
				{
					return -1;
				}
		...
		struct ResourcesFileHeader : public core::binaryserializer::BinarySerialiable
		{
			...
			std::ptrdiff_t deserialize(core::stream::InStreamInterface& in) override
			{
				...
				bytes_read = identification_header_.deserialize(in);
				if (bytes_read == -1)
				{
					return -1;
				}
			...
			std::ptrdiff_t serialize(cyanvne::core::stream::OutStreamInterface& out) const override
			{
				...
				bytes_written = identification_header_.serialize(out);
				if (bytes_written == -1)
				{
					return -1;
				}
